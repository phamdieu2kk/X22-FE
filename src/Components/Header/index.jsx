...
const mainMenuItems = [
    {
        label: <NavLink className="nav-link" to="/">Trang chủ</NavLink>,
        key: 'home',
    },
    {
...
const mainAuthItems = [
    {
        label: <NavLink className="nav-link" to="/register">Đăng ký</NavLink>,
        key: 'register',
    },
    {
    ...
    return <Row className="header">
        ...
        <Col sm={8}>
            <Flex align="center" justify="center" className="brand">
                <img src="https://www.cubecraft.net/attachments/received_373414107023598-jpeg.177907" className="brand-logo" />
            </Flex>
        </Col>
